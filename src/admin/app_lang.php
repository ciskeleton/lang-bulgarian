...
$lang['admin_install_update_confirm'] = 'Сигурни ли сте, че искате да актуализирате този пакет?';
$lang['admin_install_update_error'] = 'Актуализирането на пакета се провали.';
$lang['admin_install_update_skip_confirm'] = 'Сигурни ли сте, че искате да пропуснете тази актуализация?';
$lang['admin_install_update_skip_error'] = 'Неуспешно пропускане на тази актуализация.';
$lang['admin_install_update_skip_success'] = 'Актуализацията беше пропусната успешно.';
$lang['admin_install_update_success'] = 'Пакетът е актуализиран успешно.';
...
$lang['admin_modules_delete_error_active'] = 'Активните модули не могат да бъдат изтрити.';
...
$lang['admin_modules_global'] = 'Глобален модул (споделен)';
$lang['admin_modules_install_confirm'] = 'Сигурни ли сте, че искате да инсталирате модула: <b>%s</b>?';
$lang['admin_modules_install_error'] = 'Инсталирането на модула се провали.';
$lang['admin_modules_install_success'] = 'Модулът е инсталиран успешно.';
...
$lang['admin_modules_update_confirm'] = 'Сигурни ли сте, че искате да актуализирате този модул?';
$lang['admin_modules_update_error'] = 'Актуализирането на модула се провали.';
$lang['admin_modules_update_success'] = 'Модулът е актуализиран успешно.';
...
$lang['admin_plugins_delete_error_active'] = 'Активните приставки не могат да бъдат изтрити.';
...
$lang['admin_plugins_global'] = 'Глобална приставка (споделена)';
$lang['admin_plugins_install_confirm'] = 'Сигурни ли сте, че искате да инсталирате приставката: <b>%s</b>?';
$lang['admin_plugins_install_error'] = 'Инсталирането на приставката се провали.';
$lang['admin_plugins_install_success'] = 'Приставката е инсталирана успешно.';
...
$lang['admin_plugins_update_confirm'] = 'Сигурни ли сте, че искате да актуализирате тази приставка?';
$lang['admin_plugins_update_error'] = 'Актуализирането на приставката се провали.';
$lang['admin_plugins_update_success'] = 'Приставката е актуализирана успешно.';
...
$lang['admin_themes_disable_error_active'] = 'Активната тема не може да бъде деактивирана.';
...
$lang['admin_themes_install_confirm'] = 'Сигурни ли сте, че искате да инсталирате темата: <b>%s</b>?';
$lang['admin_themes_install_error'] = 'Инсталирането на темата се провали.';
$lang['admin_themes_install_success'] = 'Темата е инсталирана успешно.';
...
$lang['admin_themes_update_confirm'] = 'Сигурни ли сте, че искате да актуализирате тази тема?';
$lang['admin_themes_update_error'] = 'Актуализирането на темата се провали.';
$lang['admin_themes_update_success'] = 'Темата е актуализирана успешно.';
...
$lang['admin_languages_delete_confirm'] = 'Сигурни ли сте, че искате да изтриете езика: <b>%s</b>?';
$lang['admin_languages_delete_error'] = 'Изтриването на езика се провали.';
$lang['admin_languages_delete_error_active'] = 'Активните езици не могат да бъдат изтрити.';
$lang['admin_languages_delete_error_default'] = 'Езикът по подразбиране не може да бъде изтрит.';
$lang['admin_languages_delete_success'] = 'Езикът е изтрит успешно.';
...
$lang['admin_languages_install_confirm'] = 'Сигурни ли сте, че искате да инсталирате езика: <b>%s</b>?';
$lang['admin_languages_install_error'] = 'Инсталирането на езика се провали.';
$lang['admin_languages_install_success'] = 'Езикът е инсталиран успешно.';
...
$lang['admin_languages_update_confirm'] = 'Сигурни ли сте, че искате да актуализирате този език?';
$lang['admin_languages_update_error'] = 'Актуализирането на езика се провали.';
$lang['admin_languages_update_success'] = 'Езикът е актуализиран успешно.';
 ...
 */
$lang['package_already_exists'] = 'Пакетът вече съществува.';
$lang['package_archive_download_failed'] = 'Неуспешно изтегляне на архивния пакет.';
$lang['package_backup_create_error'] = 'Неуспешно създаване на архив на пакета.';
$lang['package_backup_dir_failed'] = 'Неуспешно създаване на резервна директория %s';
$lang['package_backup_missing'] = 'Архиwният файл не съществува.';
$lang['package_backup_path_error'] = 'Пътят към архивния файл не може да бъде разпознат.';
$lang['package_backup_request_invalid'] = 'Невалидна заявка за архив.';
$lang['package_backup_restore_error'] = 'Неуспешно възстановяване на архива на пакета.';
$lang['package_catalog_type_unknown'] = 'Непознат тип каталог.';
$lang['package_checksum_error'] = 'Проверката на контролната сума (checksum) на пакета неуспя.';
$lang['package_copy_files_error'] = 'Неуспешно копиране на файловете на пакета към дестинацията.';
$lang['package_copy_updates_error'] = 'Неуспешно копиране на файловете за актуализация към дестинацията.';
$lang['package_dest_dir_failed'] = 'Неуспешно създаване на целевата директория %s';
$lang['package_destination_error'] = 'Дестинацията на пакета не може да бъде разрешена.';
$lang['package_download_dir_failed'] = 'Неуспешно създаване на директория за изтегляне %s';
$lang['package_download_empty'] = 'Изтеглянето на пакета върна празен отговор.';
$lang['package_download_request_invalid'] = 'Невалидна заявка за изтегляне на пакет.';
$lang['package_extract_failed'] = 'Неуспешно разקачване на ZIP файла %s';
$lang['package_invalid_lang_files'] = 'Невалиден език — липсват задължителни езикови файлове на приложението.';
$lang['package_invalid_lang_structure'] = 'Невалиден език — липсват директории admin и/или ci3.';
$lang['package_invalid_missing_info'] = 'Невалиден %s: липсва "info.php".';
$lang['package_invalid_module_structure'] = 'Невалиден модул — липсват задължителни директории config и/или controllers.';
$lang['package_invalid_plugin_boot'] = 'Невалиден плъгин — липсва "boot.php".';
$lang['package_invalid_plugin_contents'] = 'Невалиден плъгин — плъгините не могат да съдържат controllers или views.';
$lang['package_invalid_theme_boot'] = 'Невалидна тема — липсва "boot.php".';
$lang['package_invalid_theme_views'] = 'Невалидна тема — липсва директория views.';
$lang['package_no_root_dir'] = 'Пакетът не съдържа основна директория (root).';
$lang['package_not_downloadable'] = 'Пакетът не подлежи на публично изтегляне.';
$lang['package_not_in_registry'] = 'Пакетът не е наличен в публичния регистър.';
$lang['package_request_invalid'] = 'Невалидна заявка за пакет.';
$lang['package_rollback_request_invalid'] = 'Невалидна заявка за връщане на предишна версия.';
$lang['package_root_mismatch'] = 'Основната директория на архивния пакет не съответства на %s';
$lang['package_single_root_required'] = 'Пакетът трябва да съдържа точно една основна директория.';
$lang['package_source_error'] = 'Източникът на пакета не може да бъде разрешен.';
$lang['package_system_core_restricted'] = 'Системните компоненти не могат да бъдат инсталирани като пакети.';
$lang['package_temp_dir_failed'] = 'Неуспешно създаване на временна директория %s';
$lang['package_type_unknown'] = 'Непознат тип пакет.';
$lang['package_update_request_invalid'] = 'Невалидна заявка за актуализация на пакет.';
$lang['package_update_root_mismatch'] = 'Основната директория на архива за актуализация не съответства на %s.';
$lang['package_upload_dir_failed'] = 'Неуспешно създаване на директория за качване %s';
$lang['package_url_invalid'] = 'Невалиден URL адрес за разпределение на пакета.';
$lang['package_write_failed'] = 'Неуспешен запис на пакета в %s';
$lang['package_zip_not_found'] = 'ZIP пакетът не съществува: %s';
...
$lang['update_rollback_confirm'] = 'Сигурни ли сте, че искате да възстановите предишната версия?';
